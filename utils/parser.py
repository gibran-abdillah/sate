...
def get_parser():
    ...
    parser.add_argument("-u", "--url", type=str, dest="url", help="URL to scan")
    parser.add_argument("-w", "--web-list", type=str, dest="web_list", help="Scan sites from txt file")
    parser.add_argument('--scan-plugins', action='store_true',dest="scan_plugins", help="Option to scan plugins")
    parser.add_argument('--scan-themes', action='store_true', dest="scan_themes", help="Option to scan themes")
